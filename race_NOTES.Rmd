...
A better approach might have been to treat the text as a fixed width file. This would require me to state the column widths for each file (in some cases the widths differe on different pages too). It could be robust once I have done that though.
