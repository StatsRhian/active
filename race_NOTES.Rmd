...
* `race_LOAD.R` loads the processed csvs and does some further cleaning and processing.

I've already run the first two steps so, given a folder of the correct csvs, only the last step needs to be run.
